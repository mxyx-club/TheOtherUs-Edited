...
public class DeadBodyReporter : CustomObjectBase<DeadBodyReporter>
{
    ...
    public DeadBodyReporter(PlayerControl player, DeadBody deadBody)
    {
        ...
        var localCanSeeBodies = Professional.CanSeeBodies switch
        {
            ...
            Professional.CanSeeBody.KillNeutral => PlayerControl.LocalPlayer.IsImpostor() || PlayerControl.LocalPlayer.IsKillerNeutral(),
            Professional.CanSeeBody.EvilNeutral => PlayerControl.LocalPlayer.IsImpostor() || PlayerControl.LocalPlayer.IsKillerNeutral() || PlayerControl.LocalPlayer.IsEvilNeutral(),
