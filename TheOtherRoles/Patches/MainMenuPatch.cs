...
public class MainMenuPatch
{
    ...
    private static void Prefix(MainMenuManager __instance)
    {
        ...
        passiveButtonGitHub.OnClick.AddListener((Action)(() =>
            Application.OpenURL("https://github.com/mxyx-club/TheOtherUs/")));
        ...
        if (IsCN())
        {
            ...
            _ = __instance.StartCoroutine(Effects.Lerp(0.1f,
                new Action<float>((p) => { textDiscord?.SetText("模组QQ群"); })));

            PassiveButton passiveButtonDiscord = buttonDiscord.GetComponent<PassiveButton>();
            SpriteRenderer buttonSpriteDiscord =
                buttonDiscord.transform.FindChild("Inactive").GetComponent<SpriteRenderer>();

            passiveButtonDiscord.OnClick = new ButtonClickedEvent();
            passiveButtonDiscord.OnClick.AddListener((Action)(() =>
                Application.OpenURL("https://qm.qq.com/q/Xr8HijGZK8")));
