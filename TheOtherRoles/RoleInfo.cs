...
{
    public static RoleInfo impostor = new("伪装者", Palette.ImpostorRed, Helpers.cs(Palette.ImpostorRed, "哈哈！白板内鬼~"),
        "破坏并击杀所有人", RoleId.Impostor);
    ...
    public static RoleInfo mafioso = new("小弟", Mafioso.color, "懂不懂什么叫黑手啊", "帮助<color=#FF1919FF>教父</color>干掉船员",
        RoleId.Mafioso);
    ...
    public static RoleInfo camouflager =
        new("隐蔽者", Camouflager.color, "让我们来猎杀那些陷入黑暗中的人吧", "隐藏在他人之中", RoleId.Camouflager);
    ...
    public static RoleInfo juggernaut =
        new("天启", Juggernaut.color, "吾将送汝等救赎，汝等应心怀感激", "减少CD，杀光所有人", RoleId.Juggernaut, true);

    //添加末日预言家
    public static RoleInfo doomsayer = new("末日预言家", Doomsayer.color, "将人类以善恶来区分这根本就是愚蠢的想法", "观察其他玩家，并在会议时刺杀他们",
        RoleId.Doomsayer, true);
    ...
    public static RoleInfo privateInvestigator =
        new("观察者", PrivateInvestigator.color, "查看谁在与他人互动", "卧底在飞船之中", RoleId.PrivateInvestigator);

    public static RoleInfo sheriff = new("警长", Sheriff.color, "<color=#FF1919FF>严禁</color>小脑行为！！！", "毙了伪装者",
        RoleId.Sheriff);
    ...
    public static RoleInfo detective = new("侦探", Detective.color, "从脚印之中发现<color=#FF1919FF>伪装者</color>", "检查足迹并检验尸体",
        RoleId.Detective);

    public static RoleInfo timeMaster =
        new("时间之主", TimeMaster.color, "知道我刚在时空旅行的时候见到谁了么?", "用你的护盾保护你自己", RoleId.TimeMaster);
    ...
    public static RoleInfo hunter = new("猎人", Palette.ImpostorRed, Helpers.cs(Palette.ImpostorRed, "抓捕"), "找到并击杀所有猎物",
        RoleId.Impostor);
    ...
    public static RoleInfo antiTeleport =
        new("通讯兵", Color.yellow, "线上会议！", "无需回到会议室开会", RoleId.AntiTeleport, false, true);

    public static RoleInfo tiebreaker =
        new("破平者", Color.yellow, "你说得对...但是，规则就是用来打破的", "打破平局", RoleId.Tiebreaker, false, true);

    public static RoleInfo bait = new("诱饵", Color.yellow, "牺牲小我，成就大我", "击杀你的人会立即报警", RoleId.Bait, false, true);
    ...
    public static RoleInfo multitasker =
        new("多线程", Color.yellow, "虽然人不可以三心二意，但是你可以一心二用", "交互界面透明", RoleId.Multitasker, false, true);

    public static RoleInfo lover = new("恋人", Lovers.color, "你坠入了爱河", "你坠入了爱河", RoleId.Lover, false, true);

    public static RoleInfo mini = new("小孩", Color.yellow, "《未成年人保护法》第127条[不，是第133条]", "长大之前没有人能伤害你", RoleId.Mini, false,
        true);

    public static RoleInfo vip = new("VIP", Color.yellow, "我宣布个事儿", "所有人都知道你的死讯", RoleId.Vip, false, true);

    public static RoleInfo indomitable =
        new("不屈者", Color.yellow, "无所畏惧，愈战愈勇", "无法被猜测", RoleId.Indomitable, false, true);

    public static RoleInfo slueth = new("掘墓人", Color.yellow, "我才是法医！", "报告可知晓死者职业", RoleId.Slueth, false, true);

    public static RoleInfo cursed = new("反骨", Color.yellow, "你是船员....至少现在是", "被内鬼击杀会变成内鬼", RoleId.Cursed, false, true,
        true);
    ...
    public static RoleInfo watcher = new("窥视者", Color.yellow, "来来来，我看看你们怎么投票的啊", "你可以知晓所有人的投票情况", RoleId.Watcher, false,
        true);
    ...
    public static RoleInfo shifter = new("交换师", Color.yellow, "你的能力真好用！马上就是我的了！", "与他人交换职业", RoleId.Shifter, false,
        true);
        ...
        if (!suppressGhostInfo && p != null)
        {
            ...
            if (p == Vulture.vulture && (CachedPlayer.LocalPlayer.PlayerControl == Vulture.vulture ||
                ...
                roleName = roleName + Helpers.cs(Vulture.color,
                    $" ({Vulture.vultureNumberToWin - Vulture.eatenBodies} 剩余)");
                    ...
                    if (deadPlayer != null)
                    {
                        switch (deadPlayer.deathReason)
                        {
                            ...
                            case DeadPlayer.CustomDeathReason.WitchExile:
                                deathReasonString =
                                    $" - {Helpers.cs(Witch.color, "被咒杀")} 于 {Helpers.cs(killerColor, deadPlayer.killerIfExisting.Data.PlayerName)}";
                                break;
                            ...
                            case DeadPlayer.CustomDeathReason.Bomb:
                                deathReasonString =
                                    $" - 被爆破于 {Helpers.cs(killerColor, deadPlayer.killerIfExisting.Data.PlayerName)}";
                                break;
